        ...
        <div className="col-12 col-md-7">
          <div className="p-3">
            ...
            <p className="fs-5">
              ...
              laboratory and Expertice doctor. MediSure ensures the best health
              care as well as clinical service with outstanding personal
              service.{" "}
            </p>
            <p className="fs-5">
              The motto of Medisure is that human care is more than healthcare.
              We prefer quality over anything.
            </p>
          </div>
        </div>
      </div>
