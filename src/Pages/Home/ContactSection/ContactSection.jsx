        ...
        <div className="col">
          <div className="p-3 w-75 mx-auto">
            ...
            <p className="fw-bold text-secondary">
              MediSure ensures the best health care as well as clinical service
              with outstanding personal service. We ensures the best health care
              as well as clinical service with outstanding personal service.
            </p>
            <p className="mt-4">
              <i className="blue-color fas fa-location-arrow"></i> Tupac Amaru
              200 - Lima
            </p>
            <p>
